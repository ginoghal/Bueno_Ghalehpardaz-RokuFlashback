...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 10-Abr-2020 às 01:54
...
--
-- Estrutura da tabela `tbl_arating`
--
...
--
-- Extraindo dados da tabela `tbl_arating`
--
...
--
-- Extraindo dados da tabela `tbl_cast`
--
...
--
-- Extraindo dados da tabela `tbl_director`
--
...
--
-- Extraindo dados da tabela `tbl_genre`
--
...
CREATE TABLE IF NOT EXISTS `tbl_movies` (
  ...
  `for_kids` varchar(3) NOT NULL DEFAULT 'no',
...
INSERT INTO `tbl_movies` (`movies_id`, `movies_cover`, `movies_title`, `movies_year`, `movies_runtime`, `movies_storyline`, `movies_trailer`, `movies_release`, `for_kids`) VALUES
...
(4, 'okja.jpg', 'Okja', '2017', '2h', ' Meet Mija, a young girl who risks everything to prevent a powerful, multi-national company from kidnapping her best friend - a fascinating animal named Okja. ', 'Okja.mp4', 'June 28,2017', 'no'),
...
(7, 'deadpool.jpg', 'Deadpool', '2016', '1h 48m', 'A fast-talking mercenary with a morbid sense of humor is subjected to a rogue experiment that leaves him with accelerated healing powers and a quest for revenge.', 'Bloodpool.mp4', 'Febuary 12, 2016', 'no'),
(8, 'arrival.jpg', 'Arrival', '2016', '1h 56m', 'When twelve mysterious spacecraft appear around the world, linguistics professor Louise Banks is tasked with interpreting the language of the apparent alien visitors.', 'Arrival.mp4', 'November 11, 2016', 'no'),
(9, 'eddie.jpg', 'Eddie the Eagle', '2016', '1h 46m', 'The story of Eddie Edwards, the notoriously tenacious British underdog ski jumper who charmed the world at the 1988 Winter Olympics.', 'Eddie.mp4', 'Febuary 26, 2016', 'no'),
...
(12, 'brooklyn.jpg', 'Brooklyn', '2015', '1h 57m', 'An Irish immigrant lands in 1950s Brooklyn, where she quickly falls into a romance with a local. When her past catches up with her, however, she must choose between two countries and the lives that exist within.', 'Brooklyn.mp4', 'November 25, 2015', 'no'),
(13, 'walk.jpg', 'The Walk', '2015', '2h 3m', 'In 1974, high-wire artist Philippe Petit recruits a team of people to help him realize his dream: to walk the immense void between the World Trade Center towers.', 'Walk.mp4', 'October 9, 2015', 'no'),
...
(15, 'force.jpg', 'Star Wars: The Force Awakens', '2015', '2h 16m', 'Three decades after the Empire&rsquo;s defeat, a new threat arises in the militant First Order. Stormtrooper defector Finn and spare parts scavenger Rey are caught up in the Resistance&rsquo;s search for the missing Luke Skywalker.', 'Force.mp4', 'December 18, 2015', 'no'),
(16, 'whiplash.jpg', 'Whiplash', '2014', '1h 47m', 'A promising young drummer enrolls at a cut-throat music conservatory where his dreams of greatness are mentored by an instructor who will stop at nothing to realize a student\'s potential.', 'Whiplash.mp4', 'October 15, 2014', 'no'),
...
(18, 'donjon.jpg', 'Don Jon', '2013', '1h 30m', 'A New Jersey guy dedicated to his family, friends, and church, develops unrealistic expectations from watching porn and works to find happiness and intimacy with his potential true love.', 'donjon.mp4', 'September 27, 2013', 'no'),
(19, 'gravity.jpg', 'Gravity', '2013', '1h 31m', 'Two astronauts work together to survive after an accident which leaves them alone in space.', 'Gravity.mp4', 'October 4, 2013', 'no'),
...
--
-- Estrutura da tabela `tbl_mov_cast`
--
...
--
-- Extraindo dados da tabela `tbl_mov_cast`
--
...
--
-- Estrutura da tabela `tbl_mov_country`
--
...
--
-- Extraindo dados da tabela `tbl_mov_country`
--
...
--
-- Estrutura da tabela `tbl_mov_director`
--
...
--
-- Extraindo dados da tabela `tbl_mov_director`
--
...
--
-- Estrutura da tabela `tbl_mov_genre`
--
...
--
-- Extraindo dados da tabela `tbl_mov_genre`
--
...
--
-- Estrutura da tabela `tbl_mov_lang`
--
...
--
-- Extraindo dados da tabela `tbl_mov_lang`
--
...
--
-- Estrutura da tabela `tbl_mov_studio`
--
...
--
-- Extraindo dados da tabela `tbl_mov_studio`
--
...
--
-- Estrutura da tabela `tbl_studio`
--
...
--
-- Extraindo dados da tabela `tbl_studio`
--
...
--
-- Estrutura da tabela `tbl_urating`
--
